 ...
 */
#else
#define LIBFDATA_VERSION						20140911

/* The libfdata version string
 */
#define LIBFDATA_VERSION_STRING						"20140911"
...
/* The btree node value flag definitions
 */
enum LIBFDATA_BTREE_NODE_VALUE_FLAGS
{
	LIBFDATA_BTREE_NODE_VALUE_FLAG_NON_MANAGED			= LIBFDATA_FLAG_DATA_HANDLE_NON_MANAGED,
	LIBFDATA_BTREE_NODE_VALUE_FLAG_MANAGED				= LIBFDATA_FLAG_DATA_HANDLE_MANAGED
};
...
{
	LIBFDATA_RANGE_LIST_VALUE_FLAG_NON_MANAGED			= LIBFDATA_FLAG_DATA_HANDLE_NON_MANAGED,
	LIBFDATA_RANGE_LIST_VALUE_FLAG_MANAGED				= LIBFDATA_FLAG_DATA_HANDLE_MANAGED
};
