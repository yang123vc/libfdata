 ...
 */
#else
#define LIBFDATA_VERSION						20140913

/* The libfdata version string
 */
#define LIBFDATA_VERSION_STRING						"20140913"
...
{
	LIBFDATA_FLAG_DATA_HANDLE_NON_MANAGED				= LIBFDATA_FLAG_DATA_NON_MANAGED,
	LIBFDATA_FLAG_DATA_HANDLE_MANAGED				= LIBFDATA_FLAG_DATA_MANAGED
};
...
{
	LIBFDATA_FLAG_KEY_VALUE_NON_MANAGED				= LIBFDATA_FLAG_DATA_NON_MANAGED,
	LIBFDATA_FLAG_KEY_VALUE_MANAGED					= LIBFDATA_FLAG_DATA_MANAGED
};
